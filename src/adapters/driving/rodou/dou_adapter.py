...
class DouAdapter(FetcherPort):
    ...
    def __init__(self, rodou_factory: RodouFactory):
        """
        ...
        """
        self.factory = rodou_factory
        self.searcher = rodou_factory.get_instance()
    ...
    def fetch(self, params: Optional[Dict[str, Any]] = None) -> List[FetchResult]:
        ...
        try:
            ...
            # Nota: A API exata depende da versão do Ro-DOU
